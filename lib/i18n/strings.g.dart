...
///
/// Built on 2023-10-01 at 12:51 UTC
...
class _StringsHomePageEn {
	...
	late final _StringsHomePageBottomBarEn bottomBar = _StringsHomePageBottomBarEn._(_root);
	late final _StringsHomePageDrawerEn drawer = _StringsHomePageDrawerEn._(_root);
}
...
class _StringsHomePageJa implements _StringsHomePageEn {
	...
	// Translations
	@override String get title => 'Todoリスト';
	@override late final _StringsHomePageBottomBarJa bottomBar = _StringsHomePageBottomBarJa._(_root);
	@override late final _StringsHomePageDrawerJa drawer = _StringsHomePageDrawerJa._(_root);
}
...
class _StringsHomePageDrawerJa implements _StringsHomePageDrawerEn {
	...
	// Translations
	@override String get themeModeLight => 'ライトモードに変更';
	@override String get themeModeDart => 'ダークモードに変更';
	@override String get appLocale => 'Switch to English';
}
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'homePage.title': return 'TodoList';
			case 'homePage.bottomBar.todo': return 'todo';
			case 'homePage.bottomBar.profile': return 'profile';
			case 'homePage.drawer.themeModeLight': return 'Switch to LightMode';
			case 'homePage.drawer.themeModeDart': return 'Switch to DarkMode';
			case 'homePage.drawer.appLocale': return 'Switch to English';
...
extension on _StringsJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'homePage.title': return 'Todoリスト';
			case 'homePage.bottomBar.todo': return 'todo';
			case 'homePage.bottomBar.profile': return 'プロフィール';
			case 'homePage.drawer.themeModeLight': return 'ライトモードに変更';
			case 'homePage.drawer.themeModeDart': return 'ダークモードに変更';
			case 'homePage.drawer.appLocale': return 'Switch to English';
